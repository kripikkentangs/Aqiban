            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="username" name="username">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="input-group">
                            <label class="label">Tanggal Lahir (DD/MM/YYYY)</label>
                            <input class="input--style-4" type="text" name="tanggal_lahir">
                        </div>
                        <div class="input-group">
                            <label class="label">Jenis Kelamin(L/K)</label>
                            <input class="input--style-4" type="text" name="jenis_kelamin">
                        </div>
                        <div class="input-group">
